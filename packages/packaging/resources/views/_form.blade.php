<div class="row">
  <div class="col-md-8 nopadding-right">
    <div class="form-group">
      {!! Form::label('name', trans('packaging::lang.packaging_name') . '*', ['class' => 'with-help']) !!}
      <i class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="{{ trans('packaging::lang.packaging_name') }}"></i>
      {!! Form::text('name', null, ['class' => 'form-control', 'placeholder' => trans('packaging::lang.packaging_name'), 'required']) !!}
...
<div class="row">
  <div class="col-sm-4 col-xs-12 nopadding-right">
    <div class="form-group">
      {!! Form::label('width', trans('packaging::lang.width') . '*', ['class' => 'with-help']) !!}
  ...
  <div class="col-sm-4 col-xs-12 nopadding">
    <div class="form-group">
      {!! Form::label('height', trans('packaging::lang.height') . '*', ['class' => 'with-help']) !!}
  ...
  <div class="col-sm-4 col-xs-12 nopadding-left">
    <div class="form-group">
      {!! Form::label('depth', trans('packaging::lang.depth') . '*', ['class' => 'with-help']) !!}
...
<div class="row">
  <div class="col-sm-6 nopadding-right">
    <div class="form-group">
      ...
      <i class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="{{ trans('packaging::lang.packaging_cost') }}"></i>
      <div class="input-group">
        ...
        {!! Form::number('cost', null, ['class' => 'form-control', 'step' => 'any', 'placeholder' => trans('packaging::lang.packaging_cost')]) !!}
  ...
  <div class="col-sm-6 nopadding-left">
    ...
    <div class="form-group">
      <div class="input-group">
        ...
        {!! Form::label('default', trans('packaging::lang.set_as_default_packaging')) !!}
        <span class="input-group-addon" id="basic-addon1">
          <i class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="{{ trans('packaging::lang.set_as_default_packaging') }}"></i>
        </span>
      </div>
    </div>
  </div>
...
<div class="form-group">
  ...
  @if (isset($packaging) && $packaging->featureImage)
    <label>
      <img src="{{ get_storage_file_url($packaging->featureImage->path, 'small') }}" alt="{{ trans('app.image') }}">
