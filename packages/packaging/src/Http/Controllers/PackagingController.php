...
namespace Incevio\Package\Packaging\Http\Controllers;

use App\Common\Authorizable;
use App\Http\Controllers\Controller;
use Illuminate\Http\Request;
use Incevio\Package\Packaging\Http\Requests\CreatePackagingRequest;
use Incevio\Package\Packaging\Http\Requests\UpdatePackagingRequest;
use Incevio\Package\Packaging\Repositories\PackagingRepository;
...
class PackagingController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('packaging::index', compact('packagings', 'trashes'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('packaging::_edit', compact('packaging'));
    }
