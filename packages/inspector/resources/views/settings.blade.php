        ...
        <div class="col-sm-10 nopadding-right">
          <div class="form-group">
            <div class="col-sm-3 text-right">
              {!! Form::label('inspector_keywords', trans('inspector::lang.inspector_keywords') . ':', ['class' => 'control-label']) !!}
            </div>
            <div class="col-sm-9 nopadding-left">
              ...
              <div class="help-block with-errors">
                <span class="small text-muted">{!! trans('inspector::lang.enter_your_keywords') !!}</span>
              </div>
            </div>
          </div>
          {{-- <div class="form-group">
