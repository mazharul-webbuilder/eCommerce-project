<div class="row">
  <div class="col-md-8 nopadding-right">
    <div class="form-group">
      ...
      <i class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="{{ trans('coupons::lang.coupon_name') }}"></i>
...
<div class="row">
  <div class="col-md-6 nopadding-right">
    <div class="form-group">
      ...
      <i class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="{{ trans('coupons::lang.coupon_code') }}"></i>
  ...
  <div class="col-md-6 nopadding-left">
    <div class="form-group">
      {!! Form::label('value', trans('coupons::lang.coupon_value') . '*', ['class' => 'with-help']) !!}
      <i class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="{{ trans('coupons::lang.coupon_value') }}"></i>
      <div class="input-group">
        {!! Form::number('value', null, ['class' => 'form-control', 'step' => 'any', 'placeholder' => trans('coupons::lang.coupon_value'), 'required']) !!}
...
<div class="row">
  <div class="col-md-4 nopadding-right">
    <div class="form-group">
      {!! Form::label('quantity', trans('coupons::lang.coupon_quantity') . '*', ['class' => 'with-help']) !!}
      <i class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="{{ trans('coupons::lang.coupon_quantity') }}"></i>
  ...
  <div class="col-md-4 nopadding">
    <div class="form-group">
      {!! Form::label('min_order_amount', trans('coupons::lang.coupon_min_order_amount'), ['class' => 'with-help']) !!}
      <i class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="{{ trans('coupons::lang.coupon_min_order_amount') }}"></i>
      <div class="input-group">
        ...
        {!! Form::number('min_order_amount', null, ['class' => 'form-control', 'step' => 'any', 'placeholder' => trans('coupons::lang.coupon_min_order_amount')]) !!}
  ...
  <div class="col-md-4 nopadding-left">
    <div class="form-group">
      {!! Form::label('quantity_per_customer', trans('coupons::lang.coupon_quantity_per_customer'), ['class' => 'with-help']) !!}
      <i class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="{{ trans('coupons::lang.coupon_quantity_per_customer') }}"></i>
      {!! Form::number('quantity_per_customer', !isset($coupon) ? 1 : null, ['class' => 'form-control', 'placeholder' => trans('coupons::lang.coupon_quantity_per_customer')]) !!}
      <div class="help-block with-errors"></div>
    </div>
  </div>
</div>
    ...
    <div class="form-group">
      <div class="input-group">
        ...
        <span class="input-group-addon" id="">
          <i class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="{{ trans('coupons::lang.coupon_limited_to_shipping_zones') }}"></i>
        </span>
      </div>
    </div>
  </div>
  ...
  <div class="col-md-6 nopadding-left">
    <div class="form-group">
      <div class="input-group">
        ...
        <span class="input-group-addon" id="">
          <i class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="{{ trans('coupons::lang.coupon_limited_to_customers') }}"></i>
        </span>
      </div>
    </div>
  </div>
