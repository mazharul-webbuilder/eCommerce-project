    ...
    <div class="modal-body" style="padding: 0px;">
      ...
      <div class="col-md-12 nopadding">
        <table class="table no-border">
          ...
          @endif
          <tr>
            <th class="text-right">{{ trans('coupons::lang.coupon_value') }}:</th>
            <td style="width: 65%;">
      ...
      <div class="nav-tabs-custom">
        ...
        <div class="tab-content">
          <div class="tab-pane active" id="tab_1">
            <table class="table">
              ...
              @if ($coupon->quantity_per_customer && $coupon->quantity_per_customer != 0)
                <tr>
                  <th>{{ trans('coupons::lang.coupon_quantity_per_customer') }}: </th>
              ...
              <tr>
                ...
                <td>{{ $coupon->limited ? trans('coupons::lang.limited_coupon') : trans('coupons::lang.public_coupon') }}</td>
              </tr>
            </table>
          </div>
          <!-- /.tab-pane -->
          ...
          <div class="tab-pane" id="tab_3">
            ...
            @else
              <p>{{ trans('coupons::lang.public_coupon') }} </p>
            @endif
          </div>
          <!-- /.tab-pane -->
        </div>
