...
@section('content')
  <div class="box">
    <div class="box-header with-border">
      <h3 class="box-title">{{ trans('coupons::lang.coupons') }}</h3>
      <div class="box-tools pull-right">
        @can('create', \Incevio\Package\Coupons\Models\Coupon::class)
          <a href="javascript:void(0)" data-link="{{ route('admin.promotion.coupon.create') }}" class="ajax-modal-btn btn btn-new btn-flat">{{ trans('coupons::lang.add_coupon') }}</a>
        @endcan
      </div>
    </div> <!-- /.box-header -->
    <div class="box-body">
      <table class="table table-hover table-no-sort">
        <thead>
          <tr>
            @can('massDelete', \Incevio\Package\Coupons\Models\Coupon::class)
