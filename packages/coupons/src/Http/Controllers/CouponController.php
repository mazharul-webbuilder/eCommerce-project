...
namespace Incevio\Package\Coupons\Http\Controllers;

use App\Common\Authorizable;
use App\Http\Controllers\Controller;
use Incevio\Package\Coupons\Http\Requests\CreateCouponRequest;
use Incevio\Package\Coupons\Http\Requests\UpdateCouponRequest;
use Incevio\Package\Coupons\Repositories\CouponRepository;
...
class CouponController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('coupons::index', compact('coupons', 'trashes'));
    }
    ...
    public function show($id)
    {
        ...
        return view('coupons::_show', compact('coupon'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('coupons::_edit', compact('coupon', 'customer_list'));
    }
