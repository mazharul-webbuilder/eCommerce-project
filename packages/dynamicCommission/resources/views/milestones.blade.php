          ...
          <div class="row" id="milestone{{ $key }}">
            <div class="col-sm-6">
              <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  {!! Form::number('milestones[amounts][]', $commission['milestone'], ['min' => 0, 'step' => 'any', 'class' => 'form-control', 'placeholder' => trans('dynamicCommission::lang.milestone_amount'), $commission['milestone'] == 0 ? 'disabled' : '', 'required']) !!}
            ...
            <div class="col-sm-4 nopadding-left">
              <div class="form-group">
                ...
                @endif
                <div class="input-group">
                  {!! Form::number('milestones[commissions][]', $commission['commission'], ['min' => 0, 'step' => 'any', 'class' => 'form-control', 'placeholder' => trans('dynamicCommission::lang.commission'), 'required']) !!}
