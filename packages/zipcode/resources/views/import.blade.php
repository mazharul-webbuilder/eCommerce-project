<div class="modal-dialog modal-md">
    <div class="modal-content">
        {!! Form::open(['route' => 'admin.zipcode.upload', 'files' => true, 'id' => 'form', 'data-toggle' => 'validator']) !!}
        ...
        <div class="modal-body">
            <ul>
                ...
                <li>{!! trans('help.download_template', ['url' => route('admin.zipcode.downloadTemplate')]) !!}</li>
                <li>{!! trans('zipcode::lang.required_fields_csv') !!}</li>
