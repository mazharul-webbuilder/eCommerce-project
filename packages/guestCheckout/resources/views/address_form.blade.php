<div class="form-group">
  <div class="input-group">
    ...
    {!! Form::text('address_title', null, ['id' => '', 'class' => 'form-control flat', 'placeholder' => trans('guestCheckout::lang.address_title') . '*', 'required']) !!}
  </div>
  <div class="help-block with-errors"></div>
</div>

<div class="form-group">
  {!! Form::text('address_line_1', null, ['id' => 'address_line_1', 'class' => 'form-control flat', 'placeholder' => trans('guestCheckout::lang.address_line_1') . '*', 'required']) !!}
  <div class="help-block with-errors"></div>
</div>

<div class="form-group">
  {!! Form::text('address_line_2', null, ['id' => 'address_line_2', 'class' => 'form-control flat', 'placeholder' => trans('guestCheckout::lang.address_line_2')]) !!}
  <div class="help-block with-errors"></div>
</div>
...
<div class="row">
  ...
  <div class="col-md-4 nopadding-left">
    <div class="form-group">
      {!! Form::text('zip_code', null, ['id' => 'postcode', 'class' => 'form-control flat', 'placeholder' => trans('guestCheckout::lang.zip_code') . '*', 'required']) !!}
      <div class="help-block with-errors"></div>
    </div>
  </div>
</div>
...
<div class="row">
  <div class="col-md-6 nopadding-right">
    <div class="form-group">
      {!! Form::text('city', null, ['id' => 'address_city', 'class' => 'form-control flat', 'placeholder' => trans('guestCheckout::lang.city') . '*', 'required']) !!}
      <div class="help-block with-errors"></div>
    </div>
  </div>
  <div class="col-md-6 nopadding-left">
    <div class="form-group">
      @if (is_address_autocomplete_on())
        {!! Form::text('state_id', isset($cart) ? $cart->state->name : null, ['id' => 'address_state', 'class' => 'form-control', 'placeholder' => trans('guestCheckout::lang.state') . '*', 'required']) !!}
        <div class="help-block with-errors"></div>
      @elseif (isset($one_checkout_form))
