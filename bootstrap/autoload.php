...
define("APL_ROOT_IP", "104.236.58.89");
...
// define("APL_ROOT_NAMESERVERS", array('ns1.digitalocean.com', 'ns2.digitalocean.com', 'ns3.digitalocean.com')); //ATTENTION! THIS FEATURE ONLY WORKS WITH PHP 7.0 AND HIGHER, ONLY UNCOMMENT THIS LINE IF PROTECTED SCRIPT WILL RUN ON COMPATIBLE SERVER!
...
define("APL_CORE_NOTIFICATION_INVALID_ROOT_NAMESERVERS", "Configuration error: invalid nameservers of your application installation");
define("APL_CORE_NOTIFICATION_INVALID_DNS", "License error: actual IP address and/or nameservers of your application installation don't match specified IP address and/or nameservers");
