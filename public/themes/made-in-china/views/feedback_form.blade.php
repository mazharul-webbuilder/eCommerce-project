        ...
        <div class="row">
          <div class="col-md-4 pr-0">
            <div class="well well-sm text-muted">
              <p class="lead text-center">@lang('theme.section_headings.how_to_give_feedbacks')</p>
                  ...
                  <td>
                    <div class="post-review-box">
                      ...
                      @else
                        ...
                        <div class="form-item">
                          {{ Form::textarea('comment', null, ['rows' => '2', 'class' => 'form-textarea flat', 'placeholder' => trans('theme.placeholder.write_your_feedback'), 'minlength' => '10', 'maxlength' => '250']) }}
                    ...
                    <td>
                      ...
                      @else
                        ...
                        <div class="post-review-box">
                          ...
                          <div class="form-item">
                            {{ Form::textarea('items[' . $item->pivot->inventory_id . '][comment]', null, ['rows' => '2', 'class' => 'form-textarea flat', 'placeholder' => trans('theme.placeholder.write_your_feedback'), 'minlength' => 10, 'maxlength' => 250]) }}
                            <div class="help-block with-errors"></div>
                          </div>
                        </div> <!-- /.post-review-box -->
                      @endif
