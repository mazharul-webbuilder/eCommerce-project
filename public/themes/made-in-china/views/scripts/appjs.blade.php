  ...
  (function($, window, document) {
    $(document).ready(function() {
      ...
      $('*[data-target-modal]').on('click', function(e) {
        e.preventDefault();
        $($(this).data('target-modal')).addClass('open');
      })
      ...
      $(".modalAction").on("click", function(e) {
        ...
        $.get(url, function(data) {
          remove_busy_filter('body');
          $('#myDynamicModal').html(data).addClass('open');
          //Initialize application plugins after ajax load the content
          if (typeof initAppPlugins == 'function') {
            initAppPlugins();
          }
    ...
    function initAppPlugins() {
        ...
        $.ajax({
          ...
          complete: function(xhr, textStatus) {
            if (200 == xhr.status) {
              ...
              @include('theme::layouts.notification', ['message' => trans('theme.item_not_available'), 'type' => 'warn', 'icon' => 'info-circle'])
              ...
              @include('theme::layouts.notification', ['message' => trans('theme.notify.failed'), 'type' => 'warn', 'icon' => 'times-circle'])
            }
          },
        });
      });
      ...
      // Modal close button only for made in chaina theme
      $('.modal-exit').on('click', function(event) {
        event.preventDefault();
        $('#myDynamicModal').removeClass('open');
