          ...
          <div class="tab-content">
            <div class="tab-pane active" id="description_tab">
              <div class="row">
                ...
                <div class="col-sm-9">
                  <span>
                    <i class="fas fa-crown mr-1 text-muted"></i> {!! $brand->name !!}
                  </span>
                  <br />
                  <span>
                    <i class="fas fa-map-marker-alt mr-2 text-muted"></i> {!! optional($brand->country)->name !!}
                  </span>
                  <br />
                  <p class="mt-2">
                    <i class="fas fa-store mr-2 text-muted"></i> {!! $brand->description !!}
                  </p>
