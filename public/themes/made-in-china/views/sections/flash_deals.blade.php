                        ...
                        <div class="sell-header">
                            ...
                            <div class="sell-header__sell">
                                ...
                                <div class="sell-header__sell-time">
                                    <p>
                                        <span class="deal-counter-days"></span> {{ trans('theme.flash_deal_days') }} :
                                        <span class="deal-counter-hours"></span> {{ trans('theme.hrs') }} : <span
                                                class="deal-counter-minutes"></span> {{ trans('theme.mins') }} : <span
                                                class="deal-counter-seconds"></span> {{ trans('theme.sec') }}
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="best-deal__arrow">
                                <ul>
                                    <li>
                                        <button class="left-arrow slider-arrow slick-arrow flashdeal-left"><i
                                                    class="fal fa-chevron-left"></i></button>
                                    </li>

                                    <li>
                                        <button class="right-arrow slider-arrow slick-arrow flashdeal-right"><i
                    ...
                    <div class="flash-deal__product-main">
                        <div class="row">
                            @unless(empty($flashdeals['featured']))
                                @foreach ($flashdeals['featured'] as $item)
                                    <div class="col-12 col-md-6 my-3">
                                        <div class="flash-deal__product"
                                             style="{{ empty($flashdeals['products']) ? 'margin-top: 0' : '' }}">
                                            <div class="flash-deal__product-inner">
                                                <div class="row">
                                                    <div class="col-xl-4">
                                                        <div class="flash-deal__product-image">
                                                            ...
                                                            <a href="{{ route('show.product', $item->slug) }}">
                                                                <img src="{{ get_inventory_img_src($item, 'medium') }}"
                                                    ...
                                                    <div class="col-xl-8">
                                                        <a class="flash-deal__product-name"
                                                        ...
                                                        <div class="flash-deal__product-details">
                                                            ...
                                                            <div class="flash-deal__product-price">
                                                                <span class="currant-price"><strong>{!! get_formated_price($item->current_sale_price(), config('system_settings.decimals', 2)) !!}</strong></span>
