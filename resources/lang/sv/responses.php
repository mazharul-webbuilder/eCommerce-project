<?php 
return [
  'success' => 'Åtgärden har genomförts framgångsrikt!',
  ...
  'reordered' => 'Ombeställningen lyckades',
  'no_files_to_upload' => 'Inga filer hittades för uppladdning.',
  'form_validation_failed' => 'Misslyckades: Kontrollera att alla nödvändiga ingångar är fyllda och giltiga',
  'vendor_config_failed' => 'Registreringen misslyckades! Gör några ändringar och försök igen.',
  'no_product_found_for_inventory' => 'Inga resultat! Försök med en annan söknyckel',
  'searching' => 'Sökande...',
  'you_are_blocked' => 'Du är tillfälligt blockerad från den här webbplatsen!',
  '404_not_found' => 'Tyvärr, sidan du letade efter kunde inte hittas.',
  'no_file_was_uploaded' => 'Ingen fil laddades upp.',
  'error_uploading_file' => 'Fel vid överföring av fil',
  ...
  'subscription_404' => 'Kunden har inga prenumerationer.',
];