...
return [
  ...
  'featured_img_size' => 'Utvalda bildstorlekar ska vara 285x190px',
  'brand_featured_img_size' => 'Utvalda bildstorlekar bör vara 380x160px',
  'featured_image' => 'Den här bilden visas i avsnittet Utvalda kategorier på hemsidan',
  'brand_featured_image' => 'Denna bild kommer att visas i avsnittet Utvalda märken på hemsidan',
  ...
  'slider_description' => 'Få fler ord om reglaget. Lämna det tomt om du inte vill visa beskrivningen.',
  ...
  'config_can_cancel_order_within' => 'Kunder kommer att kunna avbryta beställningen inom denna tid efter att ha gjort beställningen. Håll den tom för att möjliggöra avbokning tills beställningen uppfylls. Ställ in 0 för att inaktivera annulleringsalternativet. Kunder kan fortfarande begära avbokning till säljaren.',
  'mobile_app_slider_hits' => 'Behåll förhållandet 2: 1',
  'enable_live_chat_on_platform' => 'Om aktiverat får leverantören möjlighet att slå på / av livechatten på sin produktsida och butiksida.',
  'enable_live_chat_on_shop' => 'Aktivera livechatt på din produktsida och butiksida.',
  'package_dependency_not_loaded' => 'Beroendet misslyckades! Detta paket beror på :dependency-modul (er).',
  'option_dependence_module' => 'Beroendet misslyckades! Det här alternativet beroende :dependency-modul',
  'config_vendor_order_cancellation_fee' => 'Avbokningsavgiften när en leverantör annullerar en beställning. Ställ in 0 utan avbokningsavgift, håll tom för att ange anpassad avgift för varje beställning (avbeställning kräver administratörsgodkännande)',
  'vendor_order_cancellation_fee' => 'Avbokningsavgiften för order kommer att debiteras leverantören.',
  'disabled_when_vendor_get_paid_directly' => 'Kan inte aktiveras när leverantören får betalt direkt!',
  'confirm_uninstall_package' => 'All data relaterad till :package går förlorad för alltid! Du kan inte återställa dessa data.',
  'verify_license_key' => 'Vi skickade licensnyckeln till din e-post när du köpte. Om du inte hittar det, kontakta supporten för mer information.',
  'promotional_tagline' => 'Kampanjmärket kommer att placeras i huvudnavigeringen.',
  'best_finds_under' => 'Detta är för hemsidan <em> Best Finds Under </em> produktkarusell. Systemet väljer de bästsäljande artiklarna under denna prisgräns.',
  'featured_items' => 'Detta är för startsidan <em> Utvalda </em> avsnitt. Vi föreslår att du ställer in 5-10 artiklar.',
  'featured_categories' => 'Detta är för hemsidan <em> Utvalda kategorier </em> avsnitt. Vi föreslår att de ställer in 10-15 kategorier.',
  'trending_now_categories' => 'Detta är för hemsidan <em> trending nu kategorier </em> avsnitt. Vi föreslår att du ställer in 2-4 kategorier.',
  'featured_brands' => 'Detta är för hemsidan <em> med varumärken </em> avsnitt. Vi föreslår att du ställer in 3 varumärken.',
  'slider_alternative_color' => 'Färgen kommer att användas för text i span-taggarna.',
  'you_can_use_span_tag' => 'Du kan använda <span> -taggen för att markera viktiga ord.',
  'trending_now_category_help' => 'För bättre vy lägg till högst 5 kategorier',
  'social_auth' => 'Om aktivera alternativet för social inloggning visas på kundinloggnings- och registersidan',
  'slider_text_position' => 'Ställ in din innehållsposition på skjutreglaget. standardposition höger',
  'deal_of_the_day' => 'Bara ett objekt kan ställas in som dagens del.',
  'upload_package_zip_archive' => 'Ladda upp zip-arkivet som innehåller endast paketfilerna. Ladda inte dokumentation eller andra filer.',
  'help_clear_cache' => 'Rensa systemcache inklusive konfigurationer, bilder, rutter. Den här åtgärden kan kräva efter att du har gjort några ändringar i .ENV-filen eller några konfigurerade filer. Omedelbart kommer du att märka en prestationsuppvisning för lite men oroa dig inte, det är bara för den första belastningen.',
  'this_will_overwrite_by_dynamic_commission' => 'När Dynamic Commission Plugin är aktiv. Detta kommer att skriva över det dynamiska värdet.',
  'transaction_fee_will_charge' => 'Transaktionsavgiften debiteras även när kommissionen är noll.',
  'icon_size' => 'Ikonen ska vara en 32x32px .png bild',
  'icon_image' => 'Den här ikonbilden visas i kategori Group Dropdown som kategori Gruppikon.',
  'changes_can_take_time' => 'Ändringarna kan ta upp till :time för att påverka resultatet.',
];
