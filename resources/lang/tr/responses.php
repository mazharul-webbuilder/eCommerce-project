<?php 
return [
  'success' => 'Eylem başarıyla gerçekleştirildi!',
  ...
  'reordered' => 'Başarıyla yeniden sıralandı',
  ...
  'vendor_config_failed' => 'Kayıt başarısız! Lütfen bazı değişiklikler yapıp tekrar deneyin.',
  'no_product_found_for_inventory' => 'Sonuç bulunamadı! Lütfen farklı arama anahtarını deneyin',
  'searching' => 'Aranıyor...',
  'you_are_blocked' => 'Bu siteden geçici olarak engelleniyorsunuz!',
  '404_not_found' => 'Üzgünüz, aradığınız sayfa bulunamadı.',
  'no_file_was_uploaded' => 'Dosya yüklenmedi.',
  ...
  'subscription_404' => 'Müşterinin herhangi bir aboneliği yok.',
];