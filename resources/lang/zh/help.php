...
return [
  ...
  'featured_img_size' => '精选图片尺寸应为285x190px',
  'brand_featured_img_size' => '精选图片尺寸应为380x160px',
  'featured_image' => '此图像将显示在主页上的“特色类别”部分中',
  'brand_featured_image' => '此图像将显示在主页上的“特色品牌”部分中',
  ...
  'slider_description' => '关于滑块的更多信息。如果不想显示说明，请将其保留为空白。',
  ...
  'config_can_cancel_order_within' => '客户可以在下订单后的这段时间内取消订单。将其保留为空以允许取消直到订单履行。设置为0以禁用取消选项。客户仍然可以向供应商请求取消。',
  'mobile_app_slider_hits' => '保持比例2：1',
  'enable_live_chat_on_platform' => '如果启用，供应商将获得在其产品页面和商店页面上打开/关闭实时聊天的选项。',
  'enable_live_chat_on_shop' => '在产品页面和商店页面上启用实时聊天。',
  'package_dependency_not_loaded' => '依赖失败！该软件包取决于 :dependency模块。',
  'option_dependence_module' => '依赖失败！此选项依赖 :dependency模块',
  'config_vendor_order_cancellation_fee' => '供应商取消订单时的取消费用。设置为0时不收取取消费用，保留为空即可为每个订单设置自定义费用（取消将需要管理员批准）',
  'vendor_order_cancellation_fee' => '订单取消费将向供应商收取。',
  'disabled_when_vendor_get_paid_directly' => '供应商直接付款时无法启用！',
  'confirm_uninstall_package' => '与 :package相关的所有数据将永远丢失！您无法还原这些数据。',
  'verify_license_key' => '购买时，我们会将许可证密钥发送到您的电子邮件中。如果找不到，请与支持人员联系以获取详细信息。',
  'promotional_tagline' => '促销标语将放置在主导航上。',
  'best_finds_under' => '这是首页<em> Best Finds </em>产品轮播的。系统将在此价格限制下选择最畅销的商品。',
  'featured_items' => '这是主页<em>精选</em>部分的内容。我们建议设置5-10个项目。',
  'featured_categories' => '这适用于主页<EM>特色类别</EM>部分。我们建议设置10-15类。',
  'trending_now_categories' => '这适用于现在的HomePage <EM> Trending类别</EM>部分。我们建议设置2-4类。',
  'featured_brands' => '这是主页<EM>特色品牌</EM>部分。我们建议设定3个品牌。',
  'slider_alternative_color' => '该颜色将用于span标签内的文本。',
  'you_can_use_span_tag' => '您可以使用<span>标记突出显示重要单词。',
  'trending_now_category_help' => '为了获得更好的视图，请添加最多5个类别',
  'social_auth' => '如果启用，则社交登录选项将显示在客户登录和注册页面上',
  'slider_text_position' => '在滑块上设置内容位置。默认位置右',
  'deal_of_the_day' => '一天只可以设置一项。',
  'upload_package_zip_archive' => '上传包含包文件的zip存档。不要上传文档或其他文件。',
  'help_clear_cache' => '清除系统缓存，包括配置，图像，路由。在您在.env文件或任何配置文件中进行了一些更改后，此操作可能需要。你会立即注意到一个表演摊牌，但别担心，它只是第一个负载。',
  'this_will_overwrite_by_dynamic_commission' => '当动态佣金插件处于活动状态时。这将通过动态值覆盖。',
  'transaction_fee_will_charge' => '即使委员会为零，交易费将被收取。',
  'icon_size' => '图标应为32x32px .p​​ng图像',
  'icon_image' => '此图标图像将显示在类组组下拉为类别组图标。',
  'changes_can_take_time' => '更改可能需要 :time来影响结果。',
];
